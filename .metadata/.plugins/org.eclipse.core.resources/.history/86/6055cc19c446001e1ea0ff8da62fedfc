...
public class ProductController {
	...
	public ResponseEntity<Object> getOneProduct(@PathVariable(value="id") UUID id){ //Essa anotação obtém o id quem vem na URI, dentro de value é o valor definido na URI, e em seguida o tipo do mesmo
